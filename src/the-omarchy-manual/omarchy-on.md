...
CachyOS is a fork of Arch with a range of performance optimizations applied. I was never able to see any advantage with my workloads in terms of performance, but if you want to give it a try, here's [a guide to running Omarchy on top of CachyOS](https://github.com/basecamp/omarchy/discussions/650).
